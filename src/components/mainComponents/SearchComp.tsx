...
type TaskType = "Тест" | "Стаття" | "Розгорнута відповідь";
type Tag =
      ...
      >
        ...
        <FormControl fullWidth size="small">
          ...
          >
            ...
            <MenuItem value="Стаття">Стаття</MenuItem>
            <MenuItem value="Розгорнута відповідь">Розгорнута відповідь</MenuItem>
          </Select>
        </FormControl>
